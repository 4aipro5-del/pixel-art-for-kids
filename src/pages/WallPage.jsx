    ...
    <div className="h-screen w-screen flex flex-col overflow-hidden" style={{ background: PAGE_BG }}>
      ...
      >
        ...
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-sm font-black tracking-tight text-gray-100">공유 담벼락</span>
        </div>
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {error && (
          <div className="flex flex-col items-center justify-center h-full gap-3">
            <div className="w-16 h-16 rounded-2xl flex items-center justify-center text-3xl" style={{ background: 'rgba(248,113,113,0.12)' }}>😢</div>
        ...
        {!loading && !error && posts.length === 0 && (
          <div className="flex flex-col items-center justify-center h-full gap-4">
            <div className="w-20 h-20 rounded-2xl border-2 flex items-center justify-center text-4xl"
              style={{ borderColor: ACCENT, background: PANEL_BG }}>
              🖼️
            </div>
